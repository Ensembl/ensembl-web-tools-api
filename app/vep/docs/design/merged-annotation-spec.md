...
Three rendered views live beside this doc, all self-contained theme-aware SVG
(no runtime, no mermaid), in increasing detail:

- `concept-map.html` — the **shape of the thing**: four boxes and the traffic
  between them, in the spirit of the original hand-drawn plan. Start here.
  Generated by `concept-map.py`.
