...
<!-- Generated by repo-overview.py. Edit that and re-run; changes made here are lost on the next generate. -->
...
<div class="wrap">
  ...
  <p class="foot"><b>Generated by</b> <code>repo-overview.py</code> — edit the <code>NODES</code> / <code>EDGES</code> / <code>CONTRACTS</code> lists and re-run. Companion to <code>concept-map.html</code> (the one-page version), <code>dataflow-diagram.html</code> (the per-request sequence) and <code>spec-and-extension-guide.md</code> (the spec + how-to).</p>
</div>
"""
