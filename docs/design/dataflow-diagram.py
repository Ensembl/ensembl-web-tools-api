...
PAGE = r"""<!-- Generated by dataflow-diagram.py. Edit that and re-run; changes made here are lost on the next generate. -->
<title>VEP end-to-end dataflow</title>
<style>
  :root{
    ...
    --fs-sans:system-ui,-apple-system,"Segoe UI",Roboto,sans-serif; --maxw:76rem;
